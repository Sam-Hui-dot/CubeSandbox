...
| [Java Spring Boot Dev/Test Sandbox](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/java-springboot-web) | A Spring Boot backend template that runs a real HTTP service, warms Maven dependencies and build artifacts, snapshots the workspace, forks a fresh sandbox, and verifies inherited task state. |
