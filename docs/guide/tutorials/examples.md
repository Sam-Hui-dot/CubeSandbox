...
| [Python Incident RCA Sandbox](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/python-data-science) | A Python data-science code interpreter template for incident RCA, supporting multi-file SLO analysis, snapshot checkpoint/fork, stateful follow-up rounds, Chinese Matplotlib charts, dynamic pip installs, and packaged artifacts. |
