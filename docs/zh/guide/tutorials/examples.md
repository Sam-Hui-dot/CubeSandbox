...
| [Python 生产事故 RCA 沙箱](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/python-data-science) | 面向事故 RCA 的 Python 数据科学代码解释器模板，支持多文件 SLO 分析、有状态追问轮次、中文 Matplotlib 图表、动态 `pip` 安装和打包产物下载。 |
